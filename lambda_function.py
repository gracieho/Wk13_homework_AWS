    ...
    if age is not None:
        ...
        if age < 0:
            ...
            return build_validation_result(
                ...
                "we recommend you speak with a financial advisor for your specific circumstances."
                "Alternatively, can you provide an age between 0 and 64 please?",
            )
    ...
    if investment_amount is not None:
        ...
        if investment_amount < 5000:
            return build_validation_result(
                False,
                "investmentAmount",
                "The minimum investment amount for this service is $5,000 USD, "
